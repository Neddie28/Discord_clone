...
export const ChatItem = ({
    ...
    return (
        <div className="relative group flex items-center hover:bg-black/50
            p-4 transition w-full">
            <div className="group flex gap-x-2 items-start w-full">
                <div onClick={onMemberClick} className="cursor-pointer hover:drop-shadow-md trasition">
                ...
                <div className="flex flex-col w-full">
                    ...
                    {isImage && (
                        <a
                            ...
                            className="relative aspect-auto rounded-mdmt-2 overflow-hidden border flex
                    ...
                    {isPDF && (
                        <div className="relative flex items-center p-2 mt-2 rounded-md bg-background/10">
                            <FileIcon className="h-10 w-10 fill fill-indigo-200 stroke-indigo-400"/>
                            <a 
                                href={fileUrl}
                                target="_blank"
                                rel="noopener noreferrer"
